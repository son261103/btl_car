...
<script>
    ...
    function updatePartInfo() {
        ...
        $.getJSON(`./get_part_info.php?partId=${selectedPartId}`, function (data) {
            if (data) {
    ...
    function updateServiceInfo() {
        ...
        $.getJSON(`./get_service_info.php?serviceId=${selectedServiceId}`, function (data) {
            if (data) {
...
<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
<script>
    // Hàm updateCarInfo và updateServiceInfo tương tự như trong file them_hoadon.php
</script>
